...
_C.TEST.SAVE_FEATS = False
_C.TEST.SAVE_FEATS_DIR = ""
...
#JW
_C.MODEL.CONCAT_RGB_FEAT = False
_C.MODEL.GAZE_ENCODER = 'transformer'
_C.MODEL.USE_GAZE_ATTENTION = False
_C.MODEL.VISION_QUERY = "without_time"
_C.MODEL.USE_GAZE_SEQ = True
_C.MODEL.CROP_GAZE = False
_C.MODEL.GAZE_ATT_LAYER = "all"
_C.MODEL.GAZE_ATT_WEIGHT = 20.0
_C.MODEL.ATT_STD = 1.0
_C.MODEL.SHARE_ENCODER = False
_C.MODEL.DISTILL_MODEL_PATH = ""
_C.MODEL.DISTILL_MODEL = ""
_C.MODEL.DISTILL_LOSS_WEIGHT = 1.0
_C.MODEL.DISTILL_LOSS_FUNC = "l1"
_C.MODEL.DISTILL_ONE_FRAME = False
_C.MODEL.DISTILL_FUSION_TYPE = "late"
_C.MODEL.DISTILL_KL_WEIGHT = 0.95
_C.MODEL.SEP_ENCODER = False
_C.MODEL.NUM_LAYERS = 2
_C.MODEL.DISTILL_KL_WEIGHT_TEACHER = 1.0
_C.MODEL.SKILL_CLASSIFICATION = False
_C.MODEL.GAZE_HEAD_LENGTH = 15
_C.MODEL.IMG_MODEL = "clip"
_C.MODEL.DISTILL_LAYER_IDX = -1
...
_C.DATA.RE_PROB = 0.0
_C.DATA.SPLIT_INDEX = 0
_C.DATA.CROP_WITH_GAZE_SIZE = 224
